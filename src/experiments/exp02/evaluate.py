...
with open("results/exp02/predictions.jsonl", "w") as f:
...
with open("results/exp02/metrics.json", "w") as f:
    json.dump(summary, f, indent=2)

print("\n✅ Predicciones guardadas en results/exp02/predictions.jsonl")
print("✅ Métricas guardadas   en results/exp02/metrics.json")
